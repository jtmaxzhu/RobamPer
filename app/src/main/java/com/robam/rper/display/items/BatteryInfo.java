...
public class BatteryInfo implements Displayable {
	...
	public String getCurrentInfo() {
		float current = getCurrent(MyApplication.getContext());
		if (current != -1) {
	...
	@Override
	public void record() {
		currentBattery.add(new RecordPattern.RecordItem(System.currentTimeMillis(), getCurrent(MyApplication.getContext()), ""));
